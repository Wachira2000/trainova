      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="p-3 bg-gray-900 rounded-full w-max">
                  <div className="relative h-12 w-12 rounded-full overflow-hidden border-2 border-cyan-400">
                    <Image
                      src={expert.image}
                ...
                <div className="border-t border-gray-700 pt-6">
                  ...
                  <p className="text-cyan-400">{expert.field}</p>
                </div>
              </div>
        ...
        >
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-4">
              <div className="text-4xl font-bold text-cyan-400">450k+</div>
