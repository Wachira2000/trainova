    ...
    <section className="relative py-20 bg-black border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {experts.map((expert, index) => (
            <motion.div
              ...
              className="group relative bg-gray-800 backdrop-blur-sm p-8 rounded-2xl border border-gray-700 hover:border-gray-400 transition-all"
            >
              {/* Gradient Decoration */}
              <div className={`absolute inset-x-0 top-0 h-1 bg-white rounded-t-2xl`} />
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-gray-700 pt-6">
                  ...
                  <p className="text-gray-400">{expert.field}</p>
                </div>
              </div>
        ...
        <motion.div
          ...
          className="mt-20 text-center bg-gray-800 p-8 rounded-2xl border border-gray-700"
        >
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-4">
            ...
            <div className="p-4">
              ...
              <div className="text-gray-400">Paid to Experts</div>
            </div>
          </div>
        </motion.div>
      </div>
