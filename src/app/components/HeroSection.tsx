...
const HeroSection = () => {
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex-1 space-y-6 md:space-y-8">
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex bg-gradient-to-br from-cyan-500 to-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg sm:rounded-xl text-base sm:text-lg font-semibold items-center gap-2"
            >
              View Opportunities
